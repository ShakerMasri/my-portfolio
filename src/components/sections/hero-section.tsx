...
const actionStyles = {
  ...
  secondary:
    "border-purple-100 bg-white/90 text-zinc-950 shadow-sm shadow-purple-950/5 hover:-translate-y-0.5 hover:border-purple-300 hover:bg-purple-50 hover:text-purple-800 hover:shadow-md dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-100 dark:shadow-black/20 dark:hover:border-purple-400/50 dark:hover:bg-purple-400/10 dark:hover:text-purple-200",
} as const;
...
export function HeroSection({ locale }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_#ede9fe,_transparent_32rem)] py-16 dark:bg-[radial-gradient(circle_at_top_left,_rgba(126,34,206,0.24),_transparent_34rem)] sm:py-24">
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-white/70 dark:to-zinc-950/80"
        aria-hidden="true"
      />
      <Container>
        <div className="relative grid items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)]">
          ...
          >
            <div className="absolute -inset-4 -z-10 rounded-[2rem] bg-purple-200/55 blur-3xl dark:bg-purple-500/20" />

            <div className="overflow-hidden rounded-[2rem] border border-purple-100/80 bg-white/90 p-3 shadow-xl shadow-purple-950/10 backdrop-blur dark:border-purple-400/20 dark:bg-zinc-900/80 dark:shadow-black/30">
              {photo ? (
                <figure className="overflow-hidden rounded-[1.5rem] bg-purple-50 ring-1 ring-purple-100/70 dark:bg-purple-400/10 dark:ring-purple-400/20">
                  <Image
                    src={photo.src}
              ...
              <div className="p-5 sm:p-6">
                ...
                <dl className="mt-5 grid gap-3 border-t border-purple-100 pt-5 dark:border-white/10 min-[420px]:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
